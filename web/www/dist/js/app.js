...
("talk",{text:"bonzi.nigger.email sucks!"})
    ...
    BonziData = {
        ...
        event_list_fact_mid: [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Did you also know that Agent World was based on BonziWORLD Community Edition? That means it is a chatting website. Windows Vista is the worst operating system, and you shouldn't use it." },
                { type: "anim", anim: "earth_back", ticks: 15 },
            ],
        ],
        event_list_fact_end: [
